...
<h1 className="mypurple">If you have any query or problem or want to say something to us then please fill the form below</h1><h1 className="mypurple">You will receive reply shortly</h1>
